...
import com.example.Places.security.PrivateUrlHandler;
...
public class JettyMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        rc.packages(true, "com.example.Places.ws");
        rc.register(JacksonFeature.class);
        rc.register(MultiPartFeature.class);
        ContextHandler context = new ContextHandler("/ws/app/*");
        context.setContextPath("/ws/app/*");
        context.setHandler(new PrivateUrlHandler());
        ...
        contexts.setHandlers(new Handler[]{context, handlerWebServices, handlerPortalCtx});
        server.setHandler(contexts);

        String serverURL = "http://localhost";
        String port = "9200";

        DAOFactory.getElasticSearchDAO().init(serverURL, port);
        GestionnaireImages.init();
